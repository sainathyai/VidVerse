              ...
              <div className="flex flex-col items-center gap-6">
                {isSignUp && (
                  <div className="w-full max-w-xs">
                    <input
                      ...
                      className="w-full rounded-xl border-2 border-white/20 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md px-5 text-white text-base placeholder-white/40 focus:border-teal-400/50 focus:outline-none focus:ring-2 focus:ring-teal-400/30 hover:border-white/30 transition-all duration-300 shadow-lg"
                      placeholder="Email"
                    />
                  </div>
                )}
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    style={{ paddingTop: '0.75rem', paddingBottom: '0.75rem' }}
                    className="w-full rounded-xl border-2 border-white/20 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md px-5 pr-12 text-white text-base placeholder-white/40 focus:border-teal-400/50 focus:outline-none focus:ring-2 focus:ring-teal-400/30 hover:border-white/30 transition-all duration-300 shadow-lg"
